...
class ReviewRestaurant
{
  ...
  static public function addReview(PDO $db, int $customerid, int $restaurantId, string $reviewText, int $reviewRating)
  {
    $stmt = $db->prepare('
     INSERT INTO ReviewRestaurant ( CustomerId, RestaurantId, reviewText, ReviewRating) 
      VALUES (:CustomerId, :RestaurantId, :reviewText, :ReviewRating)
      ');
